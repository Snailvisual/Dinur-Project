...
export default function ContentPlanPage() {
  // Ganti key localStorage agar TikTok dan Instagram Content Plan terpisah
  const STORAGE_KEY = "tiktokContentPlanRows";
  const COLWIDTHS_KEY = "tiktokContentPlanColWidths";
  ...
  const [contentValueOptions, setContentValueOptions] = useState([
    ...
    { value: "Engagement", label: "Engagement", color: "bg-[#56ad9c]/20 text-[#56ad9c]" },
  ...
  const [objectiveOptions, setObjectiveOptions] = useState([
    ...
    { value: "Traffic", label: "Traffic", color: "bg-[#56ad9c]/20 text-[#56ad9c]" },
  ]);
  const [jenisKontenOptions, setJenisKontenOptions] = useState([
    { value: "Carousel Photo", label: "Carousel Photo", color: "bg-pink-200 text-pink-800" },
    { value: "Tiktok Video", label: "Tiktok Video", color: "bg-blue-200 text-blue-800" },
  ]);
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      localStorage.setItem(COLWIDTHS_KEY, JSON.stringify(colWidths));
    }
  }, [rows, colWidths]);
    ...
    <div className="space-y-8">
            ...
            <div className="flex-1 flex flex-col items-center justify-center bg-white rounded-b-2xl p-4 overflow-hidden">
              {pdfPreviewUrl === 'ERROR:INVALID_PDF' ? (
                ...
                <iframe
                  src={pdfPreviewUrl}
                  title="PDF Preview"
                  className="w-full h-[70vh] rounded-lg shadow-lg border border-[#56ad9c] bg-gray-50"
                  style={{ minHeight: 400 }}
                />
              )}
            </div>
          ...
          <div className="bg-gradient-to-br from-[#56ad9c]/10 to-[#56ad9c]/40 rounded-2xl shadow-2xl max-w-xl w-full max-h-[90vh] flex flex-col relative border-2 border-[#56ad9c] animate-fadeIn">
            ...
            <div className="flex-1 flex flex-col items-center justify-center bg-white rounded-b-2xl p-4 overflow-auto">
              <img
                ...
                className="max-h-[60vh] max-w-full rounded-lg shadow-lg border border-[#56ad9c] bg-gray-50 object-contain"
              />
            </div>
          </div>
        </div>
      )}
      <h1 className="text-3xl font-bold mb-4 text-[#56ad9c]">TikTok Content Plan</h1>
      <section className="bg-gradient-to-r from-[#56ad9c]/10 to-[#56ad9c]/40 rounded-lg shadow p-6">
        ...
        <div className="relative mt-2 w-full">
          <div className="overflow-x-auto scrollbar-thin scrollbar-thumb-blue-400 scrollbar-track-blue-100 pb-2" style={{ position: 'relative', zIndex: 1 }}>
                  ...
                  <tr key={idx} className="text-black text-sm border-b border-gray-200 last:border-b-0" style={{ fontSize: 13 }}>
                    ...
                    <td className="border px-2 py-2 text-center text-sm border-gray-200" style={{ fontSize: 13 }}>
                      {editingDateIdx === idx ? (
                        <input
                          type="date"
                          className="w-full bg-purple-50 rounded px-2 py-1 text-black text-sm"
                          value={row.tanggal}
                          autoFocus
                        ...
                        <div
                          className="w-full h-full cursor-pointer px-2 py-1 rounded hover:bg-purple-100 text-sm"
                    ...
                    <td className="border px-2 py-2 text-center text-sm border-gray-200" style={{ fontSize: 13 }}>
                      <div className="flex flex-col items-center gap-2 text-sm" style={{ fontSize: 13 }}>
                        ...
                        <div className="flex items-center gap-2 w-full justify-center text-sm" style={{ fontSize: 13 }}>
                          {!scriptFiles[idx] && (
                            <label className="cursor-pointer bg-purple-100 hover:bg-purple-200 text-purple-700 px-2 py-1 rounded font-normal border border-purple-300 text-sm" style={{ fontSize: 13, fontWeight: 400 }}>
                              Upload
                              <input
                                type="file"
                          ...
                          {scriptFiles[idx] && (
                            <button
                              ...
                              className="bg-blue-100 hover:bg-blue-200 text-blue-700 px-2 py-1 rounded font-normal border border-blue-300 transition-colors text-sm"
